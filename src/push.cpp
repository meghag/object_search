...
public:
	Push(ros::NodeHandle & n): n_(n), collision_object_current_id_(0) {
		...
		contact_point_pub_ = n_.advertise<geometry_msgs::PoseStamped>("contact_point",2);
		final_point_pub_ = n_.advertise<geometry_msgs::PoseStamped>("final_point",2);
